...
import {
  ...
  Settings, PackageCheck, CreditCard, Link2, BookOpen, BarChart3, Flower2, ShieldCheck,
} from "lucide-react";
import {
...
const items = [
  ...
  { title: "Panchakarma NABH",       url: "/admin/panchakarma", icon: Flower2 },
  { title: "Panchakarma Venues",     url: "/admin/panchakarma-venues", icon: ShieldCheck },
