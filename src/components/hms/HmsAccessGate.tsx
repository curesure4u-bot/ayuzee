      ...
      <Card className="w-full max-w-xl border-primary/20">
        <CardContent className="space-y-4 p-8">
          <div className="flex items-center gap-2 text-sm font-semibold text-primary">
            <Zap className="h-4 w-4" /> Upgrade to HMS Tools Ultra
          </div>
          <div className="flex items-center gap-2">
            <Lock className="h-5 w-5 text-muted-foreground" />
            <h2 className="font-display text-2xl">Hospital Management Add-on</h2>
          </div>
          <p className="text-sm text-muted-foreground">
            Your account already has the <strong>Ayush HMS Tool</strong> for clinical work
            (patients, consultations, prescriptions, Ashtavidha, Panchakarma).
            <br />
            <span className="mt-1 inline-block">
              <strong>HMS Tools Ultra</strong> unlocks the full hospital-management suite
              for approved centers, branches, and staff.
            </span>
          </p>
          <div className="rounded-md border bg-muted/40 p-4 text-sm">
            <p className="mb-2 font-semibold">HMS Tools Ultra includes:</p>
            <ul className="space-y-1 text-muted-foreground">
              <li>✅ OPD Queue & Token Management</li>
              <li>✅ Reception, Registration & IP Admissions</li>
              <li>✅ Billing & GST Invoices</li>
              <li>✅ MIS Reports (12 categories)</li>
              <li>✅ Ward Status & Pharmacy Orders</li>
          ...
          <Button className="w-full" onClick={() => setOpen(true)} disabled={latest?.status === "pending"}>
            {latest?.status === "rejected" ? "Re-apply for Ultra Access" : "Request HMS Tools Ultra Access"}
          </Button>
