...
export const AyushHelpMenu = () => {
  ...
  return (
    <div className="relative" onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
      ...
      {open && (
        <div className="absolute left-1/2 top-full z-[80] mt-1 w-[860px] max-w-[calc(100vw-2rem)] -translate-x-1/2 overflow-hidden rounded-2xl border border-border bg-card shadow-2xl animate-in fade-in-0 slide-in-from-top-2">
          <div className="grid grid-cols-1 md:grid-cols-[180px_1fr_240px]">
            {/* Left tabs */}
