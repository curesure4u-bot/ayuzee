...
const socialLinks = [
  ...
  { label: "Telegram", href: "https://t.me/Ayuzee_bot", Icon: TelegramIcon },
];
      ...
      <section className="bg-primary py-10 text-primary-foreground">
        <div className="container flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
            <input name="email" type="email" required maxLength={255} placeholder="Enter your email" className="w-full rounded-full border border-primary-foreground/30 bg-primary-foreground/20 px-4 py-2 text-primary-foreground placeholder:text-primary-foreground/80 outline-none ring-offset-primary focus:ring-2 focus:ring-primary-foreground sm:w-64" aria-label="Email address for newsletter" />
