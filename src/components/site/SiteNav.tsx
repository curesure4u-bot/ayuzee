...
const megaMenus: MegaMenu[] = [
  { label: "Find Care", columns: [
    { title: "By Doctor Type", links: [
      { label: "🩺 Ayurveda Doctors", to: "/doctors?system=Ayurveda" }, { label: "🧘 Yoga & Naturopathy", to: "/doctors?system=Yoga" }, { label: "🌿 Siddha Doctors", to: "/doctors?system=Siddha" }, { label: "🔵 Unani Doctors", to: "/doctors?system=Unani" }, { label: "💊 Homeopathy", to: "/homeopathy" }, { label: "🏥 Find Nearby Clinics", to: "/clinics" },
    ] },
  ...
  { label: "Therapies", columns: [
    ...
    { title: "Specialty Therapies", links: [
      ...
      { label: "Greeva Basti", to: "/therapies" },
      { label: "Uro Basti", to: "/therapies" },
      { label: "Pinda Sweda", to: "/therapies" },
    ] },
  ...
  { label: "Jobs", columns: [
    { title: "For Doctors", links: [
      { label: "🏥 Hospital Jobs", to: "/jobs?type=hospital" },
      { label: "🏢 Clinic Jobs", to: "/jobs?type=clinic" },
      { label: "🎓 Teaching & Academic", to: "/jobs?type=teaching" },
      { label: "🏛️ Government (UPSC/PSC/CGHS)", to: "/jobs/government" },
      { label: "💼 Pharma & Research", to: "/jobs?type=pharma" },
      { label: "🏨 Resort & Wellness", to: "/jobs?type=resort" },
      { label: "🕐 Part-time / Visiting", to: "/jobs?type=visiting" },
    ] },
    { title: "For Therapists & Staff", links: [
      { label: "🤲 Panchakarma Therapist Jobs", to: "/jobs?type=therapist" },
      { label: "🧘 Yoga & Naturopathy", to: "/jobs?dept=yoga-naturopathy" },
      { label: "🩺 AYUSH Nursing & Paramedical", to: "/jobs?type=paramedical" },
      { label: "💊 Pharmacy Assistant", to: "/jobs?dept=pharmacy-assistant" },
      { label: "🧪 Lab Technician", to: "/jobs?type=lab" },
      { label: "📋 All Departments →", to: "/jobs?dept=all" },
    ], card: { title: "Hire AYUSH Staff", body: "Post openings for therapists, nurses & paramedical professionals.", cta: "Post a Job", to: "/jobs/post" } },
    { title: "Smart Tools", links: [
      { label: "📋 My Job Profile", to: "/jobs/profile" },
      { label: "📂 My Applications", to: "/jobs/my-applications" },
      { label: "🤖 AI Job Match", to: "/jobs/ai-match" },
      { label: "📊 Salary Insights", to: "/jobs/salary-insights" },
      { label: "🗺️ Career Roadmap", to: "/jobs/career-roadmap" },
      { label: "🔔 My Job Alerts", to: "/jobs/alerts" },
      { label: "🔗 Jobs from Other Portals", to: "/jobs/aggregated" },
      { label: "🏥 Employer Panel", to: "/jobs/employer" },
  ...
  <div className="fixed left-0 right-0 top-[7.25rem] z-[70] max-h-[75vh] w-screen overflow-y-auto border-b border-border bg-background shadow-lg animate-in fade-in-0 slide-in-from-top-2" onMouseLeave={close}>
    <div className="container grid gap-6 py-7 lg:grid-cols-5">
      ...
      <MedicineSection title="🌿 By AYUSH System">
        <div className="space-y-1"><MedicineLink to="/shop?system=Ayurveda" close={close}>🌱 Ayurveda Medicines</MedicineLink><MedicineLink to="/homeopathy" close={close}>💊 Homeopathy</MedicineLink><MedicineLink to="/shop?system=Unani" close={close}>🌙 Unani</MedicineLink><MedicineLink to="/shop?system=Siddha" close={close}>🔵 Siddha</MedicineLink><MedicineLink to="/shop?system=Yoga" close={close}>🧘 Yoga & Naturopathy</MedicineLink></div>
        <div className="my-4 border-t border-border" />
        <h3 className="text-xs font-bold uppercase tracking-wider text-foreground">📘 Essential Drugs (Govt. AYUSH List)</h3>
        <div className="space-y-1"><MedicineLink to="/essential-drugs" close={close}>💊 Ayurveda Essential Drugs</MedicineLink><MedicineLink to="/essential-homeopathy-drugs" close={close}>💧 Homeopathy Essential Drugs</MedicineLink><MedicineLink to="/essential-siddha-drugs" close={close}>🌿 Siddha Essential Drugs</MedicineLink><MedicineLink to="/essential-unani-drugs" close={close}>🔵 Unani Essential Drugs</MedicineLink></div>
        <div className="my-4 border-t border-border" />
