...
const megaMenus: MegaMenu[] = [
  ...
  { label: "Diagnosis", columns: [
    ...
    { title: "Wellness", links: [{ label: "🍲 Food as Medicine (AYUSH)", to: "/food-as-medicine" }, { label: "💊 Essential Ayurveda Drugs", to: "/essential-drugs" }] },
  ] },
  {
    label: "Homeopathy",
    columns: [
