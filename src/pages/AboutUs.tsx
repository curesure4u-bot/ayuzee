...
export default function AboutUs() {
  usePageSEO({
    title: "About Ayuzee — India's #1 AYUSH Platform",
    description: "Ayuzee connects patients to verified Ayurveda, Homeopathy, Siddha, Unani and Yoga practitioners across India with authentic medicines and holistic therapies.",
