...
const Partner = () => {
  usePageSEO({
    title: "Partner with Ayuzee — Doctors, Clinics, Manufacturers & Colleges",
    description: "Join India's fastest-growing AYUSH platform. Onboard as a verified doctor, clinic, manufacturer, therapist or academic partner and reach patients pan-India.",
