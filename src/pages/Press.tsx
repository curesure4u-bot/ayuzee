...
const Press = () => {
  usePageSEO({
    title: "Press & Media — Ayuzee AYUSH Super-App",
    description: "Awards, media coverage and press resources for Ayuzee — India's aggregator platform for Ayurveda, Homeopathy, Siddha, Unani and Yoga.",
    canonicalPath: "/press",
  });
  return (
    <>
