            ...
            jsonLd: [
              ...
              },
              {
                ...
                itemListElement: [
                  ...
                  { "@type": "ListItem", position: 2, name: "Shop", item: "https://ayuzee.com/shop" },
                  { "@type": "ListItem", position: 3, name: p.name, item: `https://ayuzee.com/shop/${p.id}` },
                ],
              },
            ],
          },
      ...
      >
        <div className="container flex items-center justify-between gap-3 px-0">
          <div className="min-w-0">
            <p className="truncate font-display text-lg leading-tight">{formatINR(price)}</p>
            <p className="truncate text-xs text-muted-foreground">
              {inStock ? (product.unit ? `per ${product.unit}` : "Inclusive of taxes") : "Out of stock"}
            </p>
          </div>
          <Button
            variant="hero"
