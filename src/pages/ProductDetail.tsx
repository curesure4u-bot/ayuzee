      ...
      <main>
        ...
        <section className="container pb-16">
          <div className="grid gap-12 lg:grid-cols-2">
            <div className="grid aspect-square place-items-center rounded-3xl gradient-soft">
            ...
            <div>
              ...
              <div className="mt-8 flex items-center gap-4">
                <div className="flex items-center rounded-lg border border-border">
                  ...
                  <button onClick={() => setQty(qty + 1)} className="grid h-11 w-11 place-items-center hover:bg-accent" aria-label="Increase"><Plus className="h-4 w-4" /></button>
                </div>
                <Button
                  variant="hero"
                  size="lg"
