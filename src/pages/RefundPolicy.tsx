...
const RefundPolicy = () => {
  usePageSEO({
    title: "Refund & Cancellation Policy — Ayuzee",
    description: "Refund, cancellation and return policy for medicines, consultations, therapy sessions and treatment kits on Ayuzee.",
