...
const TermsOfUse = () => {
  usePageSEO({
    title: "Terms of Use — Ayuzee",
    description: "Terms governing the use of Ayuzee's AYUSH platform, consultations, medicine orders, therapies and community features.",
