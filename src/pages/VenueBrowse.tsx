      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {mapView && (
          <Card className="mb-6 overflow-hidden">
            {mapUrl ? <img src={mapUrl} alt="Map of Panchakarma therapy venues" className="h-80 w-full object-cover"  loading="lazy" decoding="async" /> : (
              ...
              return (
                <Card key={venue.id} className="overflow-hidden transition-shadow hover:shadow-lg">
                  <div className="grid md:grid-cols-[180px_1fr]">
                    {photo ? <img src={photo} alt={venue.name} className="h-48 w-full object-cover md:h-full"  loading="lazy" decoding="async" /> : (
