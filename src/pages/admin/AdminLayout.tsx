    ...
    <div className="min-h-screen bg-muted/30">
      <aside className="fixed inset-y-0 left-0 z-30 flex w-64 flex-col bg-admin-sidebar text-admin-sidebar-foreground">
        <div className="border-b border-admin-sidebar-foreground/10 p-5">
          ...
          <Badge className="mt-3 border-transparent bg-admin-danger text-destructive-foreground hover:bg-admin-danger">Super Admin</Badge>
        </div>
        <div className="border-b border-admin-sidebar-foreground/10 p-5">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-admin-sidebar-muted">Admin</p>
            </div>
          </div>
        </div>
