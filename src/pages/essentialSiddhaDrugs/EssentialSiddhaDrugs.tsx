...
const EssentialSiddhaDrugs = () => {
  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 py-8">
      <div className="mb-6">
        <h1 className="font-display text-3xl">AYUSH Essential Siddha Drugs</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          National Essential Medicines List of Siddha — {drugs.length} classical formulations across {categories.length} categories.
        </p>
      </div>
      ...
      <Card className="p-4">
        <div className="relative">
          ...
          <Input className="pl-9" placeholder="Search by name or indication (e.g. suram, vaandhi, mega noi…)" value={q} onChange={(e) => setQ(e.target.value)} />
        </div>
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2 lg:grid-cols-3">
        ...
        {filtered.map((d) => (
          <Link key={d.id} to={`/essential-siddha-drugs/${d.slug}`}>
...
export default EssentialSiddhaDrugs;
