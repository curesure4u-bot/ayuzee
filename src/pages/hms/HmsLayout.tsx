...
const tabSubItems: Record<string, { divider?: string; to: string; label: string; icon: any }[]> = {
  ...
  spine: [
    ...
    { to: "/hms/spine-modules/1", label: "M1: Posture Introduction", icon: Activity },
    { to: "/hms/spine-modules/2", label: "M2: Posterior View", icon: Activity },
    { to: "/hms/spine-modules/3", label: "M3: Anterior View", icon: Activity },
    { to: "/hms/spine-modules/4", label: "M4: Lateral View", icon: Activity },
    { to: "/hms/spine-modules/5", label: "M5: Practical Skills", icon: Activity },
    { to: "/hms/spine-modules/6", label: "M6: Functional Assessment", icon: Zap },
    { to: "/hms/spine-modules/7", label: "M7: Corrective Exercise", icon: Dumbbell },
    { to: "/hms/spine-modules/8", label: "M8: Upper Cross (UCS)", icon: AlertTriangle },
    { to: "/hms/spine-modules/9", label: "M9: Lower Cross (LCS)", icon: AlertTriangle },
    { to: "/hms/spine-modules/10", label: "M10: Layered Syndrome", icon: Activity },
