    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-8">
        ...
        <article className="mx-auto mt-6 max-w-3xl">
          ...
          {blog.cover_image_url && <img src={blog.cover_image_url} alt={blog.title} className="mt-8 aspect-[16/9] w-full rounded-2xl object-cover"  loading="lazy" decoding="async" />}
