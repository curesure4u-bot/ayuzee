        ...
        <Link key={b.id} to={`/learning/blogs/${b.slug}`}>
          <Card className="h-full overflow-hidden transition-smooth hover:-translate-y-1 hover:shadow-elegant">
            <div className="aspect-[16/10] gradient-soft">
              {b.cover_image_url ? <img src={b.cover_image_url} alt={b.title} className="h-full w-full object-cover" /> : <div className="grid h-full place-items-center font-display text-7xl text-primary/15">A</div>}
            </div>
            <div className="p-5">
