...
const Acupuncture50Diseases = () => {
  useEffect(() => {
    setSEO(
      "50 Diseases — Acupuncture Quick Protocols | Ayuzee",
      "Fast clinical reference: 50 common diseases mapped to acupuncture point protocols, integrated into the Ayuzee AYUSH platform."
    );
  }, []);
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h1 className="font-display text-2xl md:text-3xl font-bold">
                50 Diseases — Acupuncture Quick Protocols
              </h1>
              <p className="mt-2 max-w-3xl text-sm md:text-base text-muted-foreground">
                A focused, clinic-ready reference of 50 common conditions with
                acupuncture point protocols — designed for instant applicability
                during consultation.
              </p>
...
export default Acupuncture50Diseases;
