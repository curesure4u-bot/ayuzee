...
const AcupunctureHomeopathy = () => {
  useEffect(() => {
    setSEO(
      "Acupuncture × Homeopathy — Clinical Applicability | Ayuzee",
      "Integrated clinical reference combining acupuncture point protocols with matched homeopathic remedies, integrated into the Ayuzee AYUSH platform."
    );
  }, []);
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h1 className="font-display text-2xl md:text-3xl font-bold">
                Acupuncture × Homeopathy — Clinical Applicability
              </h1>
              <p className="mt-2 max-w-3xl text-sm md:text-base text-muted-foreground">
                An integrated cross-modality reference that pairs acupuncture point
                protocols with matched homeopathic remedies — designed for direct
                applicability in everyday AYUSH practice.
              </p>
...
export default AcupunctureHomeopathy;
