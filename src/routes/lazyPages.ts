...
export const AdminPlatformHealth = lazyPage(() => import("@/pages/admin/AdminPlatformHealth"));
export const AdminStrategicKPIs = lazyPage(() => import("@/pages/admin/AdminStrategicKPIs"));
export const AdminRevenueSplitDashboard = lazyPage(() => import("@/pages/admin/AdminRevenueSplitDashboard"));
export const AdminBroadcast = lazyPage(() => import("@/pages/admin/AdminBroadcast"));
export const AdminOrganogram = lazyPage(() => import("@/pages/admin/AdminOrganogram"));
export const AdminBulkActions = lazyPage(() => import("@/pages/admin/AdminBulkActions"));
export const AdminFeatureFlags = lazyPage(() => import("@/pages/admin/AdminFeatureFlags"));
export const AdminSLAEscalation = lazyPage(() => import("@/pages/admin/AdminSLAEscalation"));
export const AdminCompliance = lazyPage(() => import("@/pages/admin/AdminCompliance"));
export const AdminPartners = lazyPage(() => import("@/pages/admin/AdminPartners"));
export const AdminAPIKeys = lazyPage(() => import("@/pages/admin/AdminAPIKeys"));
export const AdminBackupExport = lazyPage(() => import("@/pages/admin/AdminBackupExport"));
export const AdminChangelog = lazyPage(() => import("@/pages/admin/AdminChangelog"));
export const AdminWhiteLabel = lazyPage(() => import("@/pages/admin/AdminWhiteLabel"));
...
export const AyushDevices = lazyPage(() => import("@/pages/shop/AyushDevices"));
export const AyuzeeMoney = lazyPage(() => import("@/pages/doctor/sections/AyuzeeMoney"));
// Beyond Praxis
export const BeyondPraxisLayout = lazyPage(() => import("@/pages/beyond/BeyondPraxisLayout"));
export const BeyondDashboard = lazyPage(() => import("@/pages/beyond/BeyondDashboard"));
export const BeyondWheelOfLife = lazyPage(() => import("@/pages/beyond/WheelOfLife"));
export const BeyondTimeManagement = lazyPage(() => import("@/pages/beyond/TimeManagement"));
export const BeyondBookLibrary = lazyPage(() => import("@/pages/beyond/BookLibrary"));
export const BeyondLeadershipLab = lazyPage(() => import("@/pages/beyond/LeadershipLab"));
export const BeyondWellnessHub = lazyPage(() => import("@/pages/beyond/WellnessHub"));
export const BeyondFinanceToolkit = lazyPage(() => import("@/pages/beyond/FinanceToolkit"));
export const BeyondCareerNavigator = lazyPage(() => import("@/pages/beyond/CareerNavigator"));
export const BeyondGuidedPathways = lazyPage(() => import("@/pages/beyond/GuidedPathways"));
export const BeyondReflectionJournal = lazyPage(() => import("@/pages/beyond/ReflectionJournal"));
export const BeyondHabitTracker = lazyPage(() => import("@/pages/beyond/HabitTracker"));
export const BeyondMyBadges = lazyPage(() => import("@/pages/beyond/MyBadges"));
...
export const BeyondLegalShield = lazyPage(() => import("@/pages/beyond/LegalShield"));
export const BeyondAIClinical = lazyPage(() => import("@/pages/beyond/AIClinicalCompanion"));
export const BeyondMicroLearning = lazyPage(() => import("@/pages/beyond/MicroLearning"));
export const BeyondChallenges = lazyPage(() => import("@/pages/beyond/Challenges"));
...
export const BeyondEvents = lazyPage(() => import("@/pages/beyond/Events"));
export const BeyondDigitalStore = lazyPage(() => import("@/pages/beyond/DigitalStore"));
export const BeyondCoaching = lazyPage(() => import("@/pages/beyond/Coaching"));
export const BeyondMembership = lazyPage(() => import("@/pages/beyond/Membership"));
export const BeyondBucketList = lazyPage(() => import("@/pages/beyond/BucketList"));
export const BeyondVisionShort = lazyPage(() => import("@/pages/beyond/VisionBoardShort"));
export const BeyondVisionLong = lazyPage(() => import("@/pages/beyond/VisionBoardLong"));
...
export const GlobalPartnerClinics = lazyPage(() => import("@/pages/global/PartnerClinicsAbroad"));
export const AIPrakritiTwin = lazyPage(() => import("@/pages/ai/PrakritiLifelongTwin"));
export const AIPredictiveRisk = lazyPage(() => import("@/pages/ai/PredictiveRiskEngine"));
export const AISmartVitals = lazyPage(() => import("@/pages/ai/SmartHomeVitals"));
export const AIFamilyGraph = lazyPage(() => import("@/pages/ai/FamilyHealthGraph"));
export const AIYogaDiet = lazyPage(() => import("@/pages/ai/AIYogaDietCoach"));
export const AIGenomeDosha = lazyPage(() => import("@/pages/ai/GenomeDoshaAnalysis"));
export const Bulk = lazyPage(() => import("@/pages/Bulk"));
export const B2BWholesale = lazyPage(() => import("@/pages/shop/B2BWholesale"));
export const BrandStorefronts = lazyPage(() => import("@/pages/shop/BrandStorefronts"));
...
export const CaseLibraryEdTech = lazyPage(() => import("@/pages/edtech/CaseLibrary"));
...
export const CertificatesEdTech = lazyPage(() => import("@/pages/edtech/Certificates"));
...
export const ColdChainLogistics = lazyPage(() => import("@/pages/shop/ColdChainLogistics"));
...
export const PGPrep = lazyPage(() => import("@/pages/edtech/PGPrep"));
...
export const SubscriptionRefillEngine = lazyPage(() => import("@/pages/shop/SubscriptionRefillEngine"));
...
export const TherapistSessionNotes = lazyPage(() => import("@/pages/therapist/TherapistSessionNotes"));
export const TherapistProgressTracker = lazyPage(() => import("@/pages/therapist/TherapistProgressTracker"));
export const TherapistAvailabilityPage = lazyPage(() => import("@/pages/therapist/TherapistAvailabilityPage"));
export const TherapistPatientHistory = lazyPage(() => import("@/pages/therapist/TherapistPatientHistory"));
export const TherapistProtocolLibrary = lazyPage(() => import("@/pages/therapist/TherapistProtocolLibrary"));
export const TherapistEducation = lazyPage(() => import("@/pages/therapist/TherapistEducation"));
export const TherapistFeedback = lazyPage(() => import("@/pages/therapist/TherapistFeedback"));
export const TherapistCommunication = lazyPage(() => import("@/pages/therapist/TherapistCommunication"));
export const TherapistSupportPage = lazyPage(() => import("@/pages/therapist/TherapistSupportPage"));
export const TherapistBranding = lazyPage(() => import("@/pages/therapist/TherapistBranding"));
export const TherapistPerformance = lazyPage(() => import("@/pages/therapist/TherapistPerformance"));
export const TherapistShiftRoster = lazyPage(() => import("@/pages/therapist/TherapistShiftRoster"));
export const TherapistMaterialLog = lazyPage(() => import("@/pages/therapist/TherapistMaterialLog"));
